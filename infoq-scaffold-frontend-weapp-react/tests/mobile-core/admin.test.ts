...
vi.mock('../../src/mobile-core/api/monitor/loginInfo', () => ({
  listLoginInfo: mockListLoginInfo
}));

vi.mock('../../src/mobile-core/api/monitor/online', () => ({
  listOnlineUsers: mockListOnlineUsers
}));

vi.mock('../../src/mobile-core/api/system/role', () => ({
  listRole: mockListRole
}));

vi.mock('../../src/mobile-core/api/system/user', () => ({
  listUser: mockListUser
}));

import { loadWorkbenchSummary, mobileAdminModules } from '../../src/mobile-core/admin';

describe('mobile-core/admin', () => {
  beforeEach(() => {

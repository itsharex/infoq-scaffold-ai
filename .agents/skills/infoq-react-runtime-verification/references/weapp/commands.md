...
Before any DevTools open command, replace `TARO_APP_ID` in `infoq-scaffold-frontend-weapp-react/.env.development` with your own WeChat mini-program AppID.

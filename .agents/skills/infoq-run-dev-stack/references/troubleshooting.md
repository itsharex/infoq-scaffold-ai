...
```bash
bash .agents/skills/infoq-run-dev-stack/scripts/start_dev_stack.sh --build-backend --force-restart
```
...
bash .agents/skills/infoq-run-dev-stack/scripts/start_dev_stack.sh --frontend-only --frontend vue --force-restart
```
...
bash .agents/skills/infoq-run-dev-stack/scripts/start_dev_stack.sh --frontend-only --frontend react --force-restart
```

## Stop and cleanly restart

```bash
bash .agents/skills/infoq-run-dev-stack/scripts/stop_dev_stack.sh
bash .agents/skills/infoq-run-dev-stack/scripts/start_dev_stack.sh
```

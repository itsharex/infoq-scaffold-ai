...
vi.mock('../../../src/mobile-core/env', () => ({
  mobileEnv: {
    clientId: 'test-client-id'
  }
}));

import { getCodeImg, getInfo, login, logout } from '../../../src/mobile-core/api/auth';
import { getDicts, listData, listType } from '../../../src/mobile-core/api/dict';
import { getCache } from '../../../src/mobile-core/api/monitor/cache';
import {
  cleanLoginInfo,
  delLoginInfo,
  listLoginInfo,
  unlockLoginInfo
} from '../../../src/mobile-core/api/monitor/loginInfo';
import { forceLogout, listOnlineUsers } from '../../../src/mobile-core/api/monitor/online';
import { cleanOperLog, delOperLog, listOperLog } from '../../../src/mobile-core/api/monitor/operLog';
import { addNotice, delNotice, getNotice, listNotice, updateNotice } from '../../../src/mobile-core/api/notice';
import { addDept, delDept, getDept, listDept, updateDept } from '../../../src/mobile-core/api/system/dept';
import { addMenu, delMenu, getMenu, listMenu, menuTreeSelect, updateMenu } from '../../../src/mobile-core/api/system/menu';
import {
  addPost,
  delPost,
  ...
  listPost,
  updatePost
} from '../../../src/mobile-core/api/system/post';
import {
  addRole,
  changeRoleStatus,
  delRole,
  ...
  optionSelectRoles,
  updateRole
} from '../../../src/mobile-core/api/system/role';
import {
  addUser,
  changeUserStatus,
  delUser,
  ...
  listUser,
  updateUser
} from '../../../src/mobile-core/api/system/user';
import {
  getUserProfile,
  updateUserProfile,
  updateUserPwd,
  uploadAvatar
} from '../../../src/mobile-core/api/user';

describe('mobile-core/api contracts', () => {
  beforeEach(() => {
